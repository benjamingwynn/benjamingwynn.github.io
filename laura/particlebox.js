	...
	draw: function() {
		...
		for (z = 0; z < particlebox.config.z_depth; z++) {
			...
			for (i = 0; i < particlebox.config.draw_amount; i++) {
				...
				context.drawImage(imageObj, particlebox.stack[z][i]["x_position"], particlebox.stack[z][i]["y_position"], particlebox.stack[z][i]["x_size"], particlebox.stack[z][i]["y_size"] * imageObj.height / imageObj.width)
